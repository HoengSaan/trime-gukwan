...
[【v1.0f】](https://github.com/HoengSaan/trime-gukwan/releases/tag/v1.0f)爲適配舊版同文（v3.34）最後一個版本，此版本亦可使用於新版同文（v3.38），但Liquid_Keyboard部份功能不可用，剪貼板不可用。

而今是爲適配新版同文（v3.38），不確保舊版同文可用性。

### 派生說明

- 「派生（前綴）」說明
  - 「**菊韻**（gukwan……）」**複雜36鍵佈局**，試圖將過多功能塞進主鍵盤佈局之中，部份人或不能接受使用。
  - 「**菊韵**（gukwan_simple……）」**普通36鍵佈局**，有拼音提示方便雙拼・三拼學習者使用。（「韵」爲「韻」異字）
  - 「**菊均**（gukwan_mini……）」**普通26鍵佈局**，有拼音提示方便雙拼・三拼學習者使用。建議使用低高度版本。（「均」爲「韻」古字）
  - 「**菊韻五段**（gukwan_godan……）」是爲探求在少於26鍵情況，有無更好佈局。在此基礎上，毋須如同9鍵，14鍵，18鍵需要對方案拼寫進行更改。此佈局參考Google Godan日文輸入法，有針對粵拼（不限於廣州話）輸入作出優化。具體請見下方說明。
- 「派生（尾綴）」說明

  - 「」：無尾綴，全高鍵盤，26鍵或36鍵佈局，假名輸入方式爲フリック，數字鍵在頂。
  - 「**小**（…low…｜小-）」：鍵盤高度變低。
  - 「**底**（……dai｜-底）」：主要佈局數字鍵在底。此派生不適用於「菊均」「菊韻五段」兩個版本，亦不適用於「行列」「注音」「九宮」三個佈局。
  - 假名輸入方式
    - 由於Rime日語輸入法不甚理想，亦非所有方案支持輸入假名，故設計假名佈局在所有方案皆可直輸假名。不諳日語者或平時無假名輸入需求者，假名輸入方式請無腦選擇五十音圖。通曉日語者，可根據自身需求選擇使用。
    - 「**フリック**」：簡潔，基於12鍵佈局更改之20鍵佈局，濁音直出，小假名直出。
    - 「**五十音圖**（…50…｜-50-）」：繁雜，但支持更多特殊假名輸入，如愛奴語假名、臺語假名等。
...
此處僅簡單展示配色同基本用法，實際佈局由於版本更新或有分別，其他鍵盤佈局請自行探索。

- 多數鍵盤用法
  - 上方符號或文字可長壓或上劃
  - 上方功能只能長壓
  - 下方符號、文字同功能通常爲左右劃，或者下劃。
- 五十音圖鍵盤用法：舊假名無法顯示。下劃同左劃爲濁音，右劃爲半濁音，上劃爲捨假名（細字）
- フリック鍵盤用法：不劃爲あ段，左劃爲い段，上劃爲う段，右劃爲え段，下劃爲お段
- 諺文鍵盤用法：韻尾須下劃或左劃輸入，其他同普通諺文輸入法無異
- 工具欄（從左到右，由於更新同圖片有差別，以文字爲準）
  - 選項菜單
  - 中文英文
  - 全角半角
  - 中標英標
...
| ![](/pic/1.jpg)                                              | ![](/pic/2.jpg)                                              |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 主鍵盤（星天｜黑白深色｜原作者配色）【菊韻底】               | 主鍵盤（白夜｜黑白淺色｜原作者配色）【菊韵】                 |
| ![](/pic/17.jpg)                                             | ![](/pic/18.jpg)                                             |
| 主鍵盤（同上）【小菊韻五段】                                 | 主鍵盤（同上）【小菊均】                                     |
| ![](/pic/3.jpg)                                              | ![](/pic/4.jpg)                                              |
...
| 九宮格鍵盤（椰海｜其他）<br />「36」即36鍵鍵盤，以解決九宮格無法漢英混打問題；下劃輸入數字 | 新基本符號（白炭｜其他）；配合九宮格鍵盤、菊韻五段、菊均使用 |
...
- 單元音
  - 「oe・io・ioe」「ae」「ia・iaa・ie」等元音建議簡拼爲「e」
  - 「aa」等元音可簡拼爲「r」
