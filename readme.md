...
- 所有佈局一覽
  ...
  - 菊韻五段50：同上，五十音圖輸入
  - 小菊韻五段：17鍵五段佈局，無提示，中鍵盤，フリック假名輸入
  - 小菊韻五段50：同上，五十音圖輸入
...
| 九宮格鍵盤（椰海｜其他）<br />「36」即36鍵鍵盤，以解決九宮格無法漢英混打問題；下劃輸入數字 | 新基本符號（白炭｜其他）；配合九宮格鍵盤、粵式五段使用       |
| ![](/pic/17.jpg)                                             |                                                              |
| 粵式五段（海傍｜其他）；說明見下                             |                                                              |

粵式五段輸入法，是爲探求在少於26鍵情況，有無比九宮格更好佈局。參考Google Godan日文輸入法佈局，根據粵語音韻特徵設計。此輸入法同九宮格鍵盤有所不同，並不影響出詞，細字（如「A」有「R」，「S」有「SH」）劃向任一方向即可是輸入，標點則只可左右劃（如「N」個感歎號要左劃，問號要右劃）。爲保證同其他拼音之相容性 ，粵式五段可輸入26個字母，亦留有36鍵鍵盤備用。
