...
- 所有佈局一覽
  ...
  - 小菊韵50：同上，五十音圖假名輸入
  - **菊韻五段：17鍵五段佈局，參照Google Godan輸入法，滑動輸入**
...
| 九宮格鍵盤（椰海｜其他）<br />「英」即36鍵鍵盤，以解決九宮格無法漢英混打問題；下劃輸入數字 | 新基本符號（白炭｜其他）；配合九宮格鍵盤、粵式五段使用       |
| ![](/pic/5d.jpg)                                             |                                                              |
| 粵式五段（海傍｜其他）；說明見下                             |                                                              |

粵式五段輸入法，是改良九宮格鍵盤之考案。參考Google Godan日文輸入法佈局，根據粵語音韻特徵設計，建議使用菊韻三拼改善粵語打字效果。此輸入法同九宮格鍵盤有所不同，並不影響出詞，所有細字（如「A」有「R」，「S」有「SH」）通過滑動任一方向即可是輸入，標點則只有滑動兩個方向。爲保證同其他拼音之相容性 ，粵式五段可輸入26個字母，亦留有36鍵鍵盤（「英」鍵）備用。
...
- 輔音
  ...
  - 疑母「ng /ŋ/」、日母「nj /ȵ/」、疑母細音「ngi」均建議簡拼爲「r」。
  - 脣化（「gw /kʷ/」「kw /kʰʷ/」），脣齒化（「gv /kᶹ/」「kv /kʰᶹ/」等）聲母建議簡拼爲「x」「q」（可調轉）。
- 單元音
  - 「oe」「ae」「io」「ia」等類似元音建議簡拼爲「e」
  - 「aa」等類似元音可簡拼爲「r」
  - 「eo」「ea」等類似元音建議簡拼爲「u」（根據情況亦可簡拼爲「a」）
- 複元音
  - 「ooi」等類似元音建議簡拼爲「ui」「uy」
  - 「ook」「oong」等類似元音建議簡拼爲「ok」「ong」
